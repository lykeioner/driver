...
#define HWRM_VERSION_RSVD 129
#define HWRM_VERSION_STR "1.10.3.129"
...
struct hwrm_async_event_cmpl_error_report_base {
	...
	#define ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_DATA1_ERROR_TYPE_LAST                         ASYNC_EVENT_CMPL_ERROR_REPORT_BASE_EVENT_DATA1_ERROR_TYPE_MD_TEMP
};
...
struct hwrm_async_error_report_dup_udcc_ses {
	__le16	type;
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_TYPE_MASK       0x3fUL
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_TYPE_SFT        0
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_TYPE_ASYNC_EVENT  0x2eUL
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_TYPE_LAST        ASYNC_ERROR_REPORT_DUP_UDCC_SES_TYPE_ASYNC_EVENT
	__le16	event_id;
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_EVENT_ID_ERROR_REPORT 0x45UL
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_EVENT_ID_LAST        ASYNC_ERROR_REPORT_DUP_UDCC_SES_EVENT_ID_ERROR_REPORT
	__le32	event_data2;
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_DST_QPN_MASK 0xffffffUL
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_DST_QPN_SFT 0
	u8	opaque_v;
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_V          0x1UL
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_OPAQUE_MASK 0xfeUL
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_OPAQUE_SFT 1
	u8	timestamp_lo;
	__le16	timestamp_hi;
	__le32	event_data1;
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_ERROR_TYPE_MASK   0xffUL
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_ERROR_TYPE_SFT    0
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_ERROR_TYPE_DUP_SES  0x7UL
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_ERROR_TYPE_LAST    ASYNC_ERROR_REPORT_DUP_UDCC_SES_ERROR_TYPE_DUP_SES
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_SRC_QPN_MASK      0xffffff00UL
	#define ASYNC_ERROR_REPORT_DUP_UDCC_SES_SRC_QPN_SFT       8
};

/* hwrm_async_error_report_db_drop (size:128b/16B) */
struct hwrm_async_error_report_db_drop {
	__le16	type;
	#define ASYNC_ERROR_REPORT_DB_DROP_TYPE_MASK       0x3fUL
	#define ASYNC_ERROR_REPORT_DB_DROP_TYPE_SFT        0
	#define ASYNC_ERROR_REPORT_DB_DROP_TYPE_ASYNC_EVENT  0x2eUL
	#define ASYNC_ERROR_REPORT_DB_DROP_TYPE_LAST        ASYNC_ERROR_REPORT_DB_DROP_TYPE_ASYNC_EVENT
	__le16	event_id;
	#define ASYNC_ERROR_REPORT_DB_DROP_EVENT_ID_ERROR_REPORT 0x45UL
	#define ASYNC_ERROR_REPORT_DB_DROP_EVENT_ID_LAST        ASYNC_ERROR_REPORT_DB_DROP_EVENT_ID_ERROR_REPORT
	__le32	event_data2;
	u8	opaque_v;
	#define ASYNC_ERROR_REPORT_DB_DROP_V          0x1UL
	#define ASYNC_ERROR_REPORT_DB_DROP_OPAQUE_MASK 0xfeUL
	#define ASYNC_ERROR_REPORT_DB_DROP_OPAQUE_SFT 1
	u8	timestamp_lo;
	__le16	timestamp_hi;
	__le32	event_data1;
	#define ASYNC_ERROR_REPORT_DB_DROP_ERROR_TYPE_MASK     0xffUL
	#define ASYNC_ERROR_REPORT_DB_DROP_ERROR_TYPE_SFT      0
	#define ASYNC_ERROR_REPORT_DB_DROP_ERROR_TYPE_DB_DROP    0x8UL
	#define ASYNC_ERROR_REPORT_DB_DROP_ERROR_TYPE_LAST      ASYNC_ERROR_REPORT_DB_DROP_ERROR_TYPE_DB_DROP
	#define ASYNC_ERROR_REPORT_DB_DROP_DROP_DEBUG_INFO_MASK 0xffffff00UL
	#define ASYNC_ERROR_REPORT_DB_DROP_DROP_DEBUG_INFO_SFT 8
};

/* hwrm_async_error_report_md_temp (size:128b/16B) */
struct hwrm_async_error_report_md_temp {
	__le16	type;
	#define ASYNC_ERROR_REPORT_MD_TEMP_TYPE_MASK            0x3fUL
	#define ASYNC_ERROR_REPORT_MD_TEMP_TYPE_SFT             0
	#define ASYNC_ERROR_REPORT_MD_TEMP_TYPE_HWRM_ASYNC_EVENT  0x2eUL
	#define ASYNC_ERROR_REPORT_MD_TEMP_TYPE_LAST             ASYNC_ERROR_REPORT_MD_TEMP_TYPE_HWRM_ASYNC_EVENT
	__le16	event_id;
	#define ASYNC_ERROR_REPORT_MD_TEMP_EVENT_ID_ERROR_REPORT 0x45UL
	#define ASYNC_ERROR_REPORT_MD_TEMP_EVENT_ID_LAST        ASYNC_ERROR_REPORT_MD_TEMP_EVENT_ID_ERROR_REPORT
	__le32	event_data2;
	#define ASYNC_ERROR_REPORT_MD_TEMP_EVENT_DATA2_CUR_TEMP_MASK 0xffUL
	#define ASYNC_ERROR_REPORT_MD_TEMP_EVENT_DATA2_CUR_TEMP_SFT 0
	#define ASYNC_ERROR_REPORT_MD_TEMP_EVENT_DATA2_THR_TEMP_MASK 0xff00UL
	#define ASYNC_ERROR_REPORT_MD_TEMP_EVENT_DATA2_THR_TEMP_SFT 8
	#define ASYNC_ERROR_REPORT_MD_TEMP_EVENT_DATA2_MODULE_MASK  0xff0000UL
	#define ASYNC_ERROR_REPORT_MD_TEMP_EVENT_DATA2_MODULE_SFT   16
	u8	opaque_v;
	#define ASYNC_ERROR_REPORT_MD_TEMP_V          0x1UL
	#define ASYNC_ERROR_REPORT_MD_TEMP_OPAQUE_MASK 0xfeUL
	#define ASYNC_ERROR_REPORT_MD_TEMP_OPAQUE_SFT 1
	u8	timestamp_lo;
	__le16	timestamp_hi;
	__le32	event_data1;
	#define ASYNC_ERROR_REPORT_MD_TEMP_ERROR_TYPE_MASK   0xffUL
	#define ASYNC_ERROR_REPORT_MD_TEMP_ERROR_TYPE_SFT    0
	#define ASYNC_ERROR_REPORT_MD_TEMP_ERROR_TYPE_MD_TEMP  0x9UL
	#define ASYNC_ERROR_REPORT_MD_TEMP_ERROR_TYPE_LAST    ASYNC_ERROR_REPORT_MD_TEMP_ERROR_TYPE_MD_TEMP
	#define ASYNC_ERROR_REPORT_MD_TEMP_TTYPE_MASK        0xff00UL
	#define ASYNC_ERROR_REPORT_MD_TEMP_TTYPE_SFT         8
	#define ASYNC_ERROR_REPORT_MD_TEMP_TTYPE_SFP_WARN      (0x0UL << 8)
	#define ASYNC_ERROR_REPORT_MD_TEMP_TTYPE_SFP_ALM       (0x1UL << 8)
	#define ASYNC_ERROR_REPORT_MD_TEMP_TTYPE_LAST         ASYNC_ERROR_REPORT_MD_TEMP_TTYPE_SFP_ALM
	#define ASYNC_ERROR_REPORT_MD_TEMP_DIR               0x10000UL
	#define ASYNC_ERROR_REPORT_MD_TEMP_DIR_FALL            (0x0UL << 16)
	#define ASYNC_ERROR_REPORT_MD_TEMP_DIR_RISE            (0x1UL << 16)
	#define ASYNC_ERROR_REPORT_MD_TEMP_DIR_LAST           ASYNC_ERROR_REPORT_MD_TEMP_DIR_RISE
};
...
struct hwrm_async_event_cmpl_adptv_qos {
	__le16	type;
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_TYPE_MASK            0x3fUL
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_TYPE_SFT             0
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_TYPE_HWRM_ASYNC_EVENT  0x2eUL
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_TYPE_LAST             ASYNC_EVENT_CMPL_ADPTV_QOS_TYPE_HWRM_ASYNC_EVENT
	__le16	event_id;
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_EVENT_ID_ADPTV_QOS 0x51UL
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_EVENT_ID_LAST     ASYNC_EVENT_CMPL_ADPTV_QOS_EVENT_ID_ADPTV_QOS
	__le32	event_data2;
	u8	opaque_v;
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_V          0x1UL
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_OPAQUE_MASK 0xfeUL
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_OPAQUE_SFT 1
	u8	timestamp_lo;
	__le16	timestamp_hi;
	__le32	event_data1;
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_EVENT_DATA1_INVAL_MASK    0xffUL
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_EVENT_DATA1_INVAL_SFT     0
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_EVENT_DATA1_INVAL_HEADROOM  0x0UL
	#define ASYNC_EVENT_CMPL_ADPTV_QOS_EVENT_DATA1_INVAL_LAST     ASYNC_EVENT_CMPL_ADPTV_QOS_EVENT_DATA1_INVAL_HEADROOM
};
...
struct hwrm_func_vf_cfg_cmd_err {
	u8	code;
	#define FUNC_VF_CFG_CMD_ERR_CODE_UNKNOWN                     0x0UL
	#define FUNC_VF_CFG_CMD_ERR_CODE_TX_RING_ASSET_TEST_FAILED   0x1UL
	#define FUNC_VF_CFG_CMD_ERR_CODE_TX_RING_RES_UPDATE_FAILED   0x2UL
	#define FUNC_VF_CFG_CMD_ERR_CODE_RSS_CTXT_ASSET_TEST_FAILED  0x3UL
	#define FUNC_VF_CFG_CMD_ERR_CODE_RSS_CTXT_RES_UPDATE_FAILED  0x4UL
	#define FUNC_VF_CFG_CMD_ERR_CODE_CMPL_RING_ASSET_TEST_FAILED 0x5UL
	#define FUNC_VF_CFG_CMD_ERR_CODE_CMPL_RING_RES_UPDATE_FAILED 0x6UL
	#define FUNC_VF_CFG_CMD_ERR_CODE_RX_RING_ASSET_TEST_FAILED   0x7UL
	#define FUNC_VF_CFG_CMD_ERR_CODE_RX_RING_RES_UPDATE_FAILED   0x8UL
	#define FUNC_VF_CFG_CMD_ERR_CODE_VNIC_ASSET_TEST_FAILED      0x9UL
	#define FUNC_VF_CFG_CMD_ERR_CODE_VNIC_RES_UPDATE_FAILED      0xaUL
	#define FUNC_VF_CFG_CMD_ERR_CODE_SYNC_STATS_THREAD_FAILED    0xbUL
	#define FUNC_VF_CFG_CMD_ERR_CODE_L2_CTXT_RES_ALLOC_FAILED    0xcUL
	#define FUNC_VF_CFG_CMD_ERR_CODE_TX_KTLS_RES_UPDATE_FAILED   0xdUL
	#define FUNC_VF_CFG_CMD_ERR_CODE_RX_KTLS_RES_UPDATE_FAILED   0xeUL
	#define FUNC_VF_CFG_CMD_ERR_CODE_TX_QUIC_RES_UPDATE_FAILED   0xfUL
	#define FUNC_VF_CFG_CMD_ERR_CODE_RX_QUIC_RES_UPDATE_FAILED   0x10UL
	#define FUNC_VF_CFG_CMD_ERR_CODE_LAST                       FUNC_VF_CFG_CMD_ERR_CODE_RX_QUIC_RES_UPDATE_FAILED
	u8	unused_0[7];
};
...
/* hwrm_func_qstats_ext_cmd_err (size:64b/8B) */
struct hwrm_func_qstats_ext_cmd_err {
	u8	code;
	#define FUNC_QSTATS_EXT_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define FUNC_QSTATS_EXT_CMD_ERR_CODE_SCHQ_STAT_GET_FAIL 0x1UL
	#define FUNC_QSTATS_EXT_CMD_ERR_CODE_SCHQ_NOT_SUPPORTED 0x2UL
	#define FUNC_QSTATS_EXT_CMD_ERR_CODE_LAST              FUNC_QSTATS_EXT_CMD_ERR_CODE_SCHQ_NOT_SUPPORTED
	u8	unused_0[7];
};
...
/* hwrm_func_backing_store_cfg_cmd_err (size:64b/8B) */
struct hwrm_func_backing_store_cfg_cmd_err {
	u8	code;
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_UNKNOWN         0x0UL
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_QP_FAIL         0x1UL
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_SRQ_FAIL        0x2UL
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_CQ_FAIL         0x3UL
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_VNIC_FAIL       0x4UL
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_STAT_FAIL       0x5UL
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_TQM_SPR_FAIL    0x6UL
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_TQM_FPR_FAIL    0x7UL
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_MRAV_FAIL       0x8UL
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_TIM_FAIL        0x9UL
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_CDU_ENABLE_FAIL 0xaUL
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_SCHQ_ALLOC_FAIL 0xbUL
	#define FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_LAST           FUNC_BACKING_STORE_CFG_CMD_ERR_CODE_SCHQ_ALLOC_FAIL
	u8	unused_0[7];
};
...
/* hwrm_func_ptp_cfg_cmd_err (size:64b/8B) */
struct hwrm_func_ptp_cfg_cmd_err {
	u8	code;
	#define FUNC_PTP_CFG_CMD_ERR_CODE_UNKNOWN                    0x0UL
	#define FUNC_PTP_CFG_CMD_ERR_CODE_DISABLE_PPS_FAILED         0x1UL
	#define FUNC_PTP_CFG_CMD_ERR_CODE_ENABLE_EXTERNAL_PPS_FAILED 0x2UL
	#define FUNC_PTP_CFG_CMD_ERR_CODE_ENABLE_INTERNAL_PPS_FAILED 0x3UL
	#define FUNC_PTP_CFG_CMD_ERR_CODE_DDL_CFG_FAILED             0x4UL
	#define FUNC_PTP_CFG_CMD_ERR_CODE_EXT_OUT_CFG_FAILED         0x5UL
	#define FUNC_PTP_CFG_CMD_ERR_CODE_LAST                      FUNC_PTP_CFG_CMD_ERR_CODE_EXT_OUT_CFG_FAILED
	u8	unused_0[7];
};
...
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_UNKNOWN                 0x0UL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_NOT_PF_FID              0x1UL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_LAG_DISABLED            0x2UL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_INVALID_ACTIVE_PORT_MAP 0x3UL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_LAG_MODE_INVALID        0x4UL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_VF_LAG_DISABLE_FAIL     0x5UL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_VF_LAG_ENABLE_FAIL      0x6UL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_INVALID_LAG_GRP_ID      0x7UL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_ALLOC_LAG_GRP_FAIL      0x8UL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_RESET_LAG_PF_CFA_FAIL   0x9UL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_CFG_LAG_ENTRY_CFA_FAIL  0xaUL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_NO_LAG_GRP_EXISTS       0xbUL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_CLEAN_FUNC_INFO_FAIL    0xcUL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_QUERY_LAG_INFO_FAIL     0xdUL
#define HWRM_FUNC_LAG_COMMON_CMD_ERR_LAST                   HWRM_FUNC_LAG_COMMON_CMD_ERR_QUERY_LAG_INFO_FAIL
...
/* hwrm_func_lag_create_cmd_err (size:64b/8B) */
struct hwrm_func_lag_create_cmd_err {
	u8	code;
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_UNKNOWN                 0x0UL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_NOT_PF_FID              0x1UL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_LAG_DISABLED            0x2UL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_INVALID_ACTIVE_PORT_MAP 0x3UL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_LAG_MODE_INVALID        0x4UL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_VF_LAG_DISABLE_FAIL     0x5UL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_VF_LAG_ENABLE_FAIL      0x6UL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_INVALID_LAG_GRP_ID      0x7UL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_ALLOC_LAG_GRP_FAIL      0x8UL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_RESET_LAG_PF_CFA_FAIL   0x9UL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_CFG_LAG_ENTRY_CFA_FAIL  0xaUL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_NO_LAG_GRP_EXISTS       0xbUL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_CLEAN_FUNC_INFO_FAIL    0xcUL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_QUERY_LAG_INFO_FAIL     0xdUL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_LAG_GRP_EXISTS          0xeUL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_PORT_EXISTS_IN_LAG_GRP  0xfUL
	#define FUNC_LAG_CREATE_CMD_ERR_CODE_LAST                   FUNC_LAG_CREATE_CMD_ERR_CODE_PORT_EXISTS_IN_LAG_GRP
	u8	unused_0[7];
};
...
/* hwrm_func_lag_update_cmd_err (size:64b/8B) */
struct hwrm_func_lag_update_cmd_err {
	u8	code;
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_UNKNOWN                 0x0UL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_NOT_PF_FID              0x1UL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_LAG_DISABLED            0x2UL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_INVALID_ACTIVE_PORT_MAP 0x3UL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_LAG_MODE_INVALID        0x4UL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_VF_LAG_DISABLE_FAIL     0x5UL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_VF_LAG_ENABLE_FAIL      0x6UL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_INVALID_LAG_GRP_ID      0x7UL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_ALLOC_LAG_GRP_FAIL      0x8UL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_RESET_LAG_PF_CFA_FAIL   0x9UL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_CFG_LAG_ENTRY_CFA_FAIL  0xaUL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_NO_LAG_GRP_EXISTS       0xbUL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_CLEAN_FUNC_INFO_FAIL    0xcUL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_QUERY_LAG_INFO_FAIL     0xdUL
	#define FUNC_LAG_UPDATE_CMD_ERR_CODE_LAST                   FUNC_LAG_UPDATE_CMD_ERR_CODE_QUERY_LAG_INFO_FAIL
	u8	unused_0[7];
};
...
/* hwrm_func_lag_free_cmd_err (size:64b/8B) */
struct hwrm_func_lag_free_cmd_err {
	u8	code;
	#define FUNC_LAG_FREE_CMD_ERR_CODE_UNKNOWN                 0x0UL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_NOT_PF_FID              0x1UL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_LAG_DISABLED            0x2UL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_INVALID_ACTIVE_PORT_MAP 0x3UL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_LAG_MODE_INVALID        0x4UL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_VF_LAG_DISABLE_FAIL     0x5UL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_VF_LAG_ENABLE_FAIL      0x6UL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_INVALID_LAG_GRP_ID      0x7UL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_ALLOC_LAG_GRP_FAIL      0x8UL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_RESET_LAG_PF_CFA_FAIL   0x9UL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_CFG_LAG_ENTRY_CFA_FAIL  0xaUL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_NO_LAG_GRP_EXISTS       0xbUL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_CLEAN_FUNC_INFO_FAIL    0xcUL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_QUERY_LAG_INFO_FAIL     0xdUL
	#define FUNC_LAG_FREE_CMD_ERR_CODE_LAST                   FUNC_LAG_FREE_CMD_ERR_CODE_QUERY_LAG_INFO_FAIL
	u8	unused_0[7];
};
...
/* hwrm_func_lag_qcfg_cmd_err (size:64b/8B) */
struct hwrm_func_lag_qcfg_cmd_err {
	u8	code;
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_UNKNOWN                 0x0UL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_NOT_PF_FID              0x1UL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_LAG_DISABLED            0x2UL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_INVALID_ACTIVE_PORT_MAP 0x3UL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_LAG_MODE_INVALID        0x4UL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_VF_LAG_DISABLE_FAIL     0x5UL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_VF_LAG_ENABLE_FAIL      0x6UL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_INVALID_LAG_GRP_ID      0x7UL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_ALLOC_LAG_GRP_FAIL      0x8UL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_RESET_LAG_PF_CFA_FAIL   0x9UL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_CFG_LAG_ENTRY_CFA_FAIL  0xaUL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_NO_LAG_GRP_EXISTS       0xbUL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_CLEAN_FUNC_INFO_FAIL    0xcUL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_QUERY_LAG_INFO_FAIL     0xdUL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_INVALID_PF_ID           0xeUL
	#define FUNC_LAG_QCFG_CMD_ERR_CODE_LAST                   FUNC_LAG_QCFG_CMD_ERR_CODE_INVALID_PF_ID
	u8	unused_0[7];
};
...
struct hwrm_queue_adptv_qos_rx_feature_cfg_cmd_err {
	u8	code;
	#define QUEUE_ADPTV_QOS_RX_FEATURE_CFG_CMD_ERR_CODE_SUCCESS                       0x0UL
	#define QUEUE_ADPTV_QOS_RX_FEATURE_CFG_CMD_ERR_CODE_UNKNOWN                       0x1UL
	#define QUEUE_ADPTV_QOS_RX_FEATURE_CFG_CMD_ERR_CODE_INTERFACES_UP                 0x2UL
	#define QUEUE_ADPTV_QOS_RX_FEATURE_CFG_CMD_ERR_CODE_MIN_TCS                       0x3UL
	#define QUEUE_ADPTV_QOS_RX_FEATURE_CFG_CMD_ERR_CODE_MAX_TCS                       0x4UL
	#define QUEUE_ADPTV_QOS_RX_FEATURE_CFG_CMD_ERR_CODE_CONTIGUOUS_TCS                0x5UL
	#define QUEUE_ADPTV_QOS_RX_FEATURE_CFG_CMD_ERR_CODE_COS_PRI_MAPPED                0x6UL
	#define QUEUE_ADPTV_QOS_RX_FEATURE_CFG_CMD_ERR_CODE_COS_PRI_PFC_ENABLED           0x7UL
	#define QUEUE_ADPTV_QOS_RX_FEATURE_CFG_CMD_ERR_CODE_DEFAULT_TCS_CANNOT_BE_CHANGED 0x8UL
	#define QUEUE_ADPTV_QOS_RX_FEATURE_CFG_CMD_ERR_CODE_MAX_LOSSLESS_TCS              0x9UL
...
struct hwrm_queue_adptv_qos_tx_feature_cfg_cmd_err {
	u8	code;
	#define QUEUE_ADPTV_QOS_TX_FEATURE_CFG_CMD_ERR_CODE_SUCCESS                       0x0UL
	#define QUEUE_ADPTV_QOS_TX_FEATURE_CFG_CMD_ERR_CODE_UNKNOWN                       0x1UL
	#define QUEUE_ADPTV_QOS_TX_FEATURE_CFG_CMD_ERR_CODE_INTERFACES_UP                 0x2UL
	#define QUEUE_ADPTV_QOS_TX_FEATURE_CFG_CMD_ERR_CODE_MIN_TCS                       0x3UL
	#define QUEUE_ADPTV_QOS_TX_FEATURE_CFG_CMD_ERR_CODE_MAX_TCS                       0x4UL
	#define QUEUE_ADPTV_QOS_TX_FEATURE_CFG_CMD_ERR_CODE_CONTIGUOUS_TCS                0x5UL
	#define QUEUE_ADPTV_QOS_TX_FEATURE_CFG_CMD_ERR_CODE_COS_PRI_MAPPED                0x6UL
	#define QUEUE_ADPTV_QOS_TX_FEATURE_CFG_CMD_ERR_CODE_COS_PRI_PFC_ENABLED           0x7UL
	#define QUEUE_ADPTV_QOS_TX_FEATURE_CFG_CMD_ERR_CODE_DEFAULT_TCS_CANNOT_BE_CHANGED 0x8UL
	#define QUEUE_ADPTV_QOS_TX_FEATURE_CFG_CMD_ERR_CODE_MAX_LOSSLESS_TCS              0x9UL
...
/* hwrm_queue_adptv_qos_rx_qcfg_input (size:256b/32B) */
struct hwrm_queue_adptv_qos_rx_qcfg_input {
	__le16	req_type;
	__le16	cmpl_ring;
	__le16	seq_id;
	__le16	target_id;
	__le64	resp_addr;
	__le32	rx_qcfg_host_addr[2];
	__le16	rx_qcfg_size;
	u8	port_id;
	u8	unused_0[5];
};

/* hwrm_queue_adptv_qos_rx_qcfg_output (size:128b/16B) */
struct hwrm_queue_adptv_qos_rx_qcfg_output {
	__le16	error_code;
	__le16	req_type;
	__le16	seq_id;
	__le16	resp_len;
...
/* hwrm_queue_adptv_qos_rx_qcfg_cmd_err (size:64b/8B) */
struct hwrm_queue_adptv_qos_rx_qcfg_cmd_err {
	u8	code;
	#define QUEUE_ADPTV_QOS_RX_QCFG_CMD_ERR_CODE_UNKNOWN           0x0UL
	#define QUEUE_ADPTV_QOS_RX_QCFG_CMD_ERR_CODE_INVALID_PORT_ID   0x1UL
	#define QUEUE_ADPTV_QOS_RX_QCFG_CMD_ERR_CODE_NO_MEM            0x2UL
	#define QUEUE_ADPTV_QOS_RX_QCFG_CMD_ERR_CODE_GET_CONFIG_FAILED 0x3UL
	#define QUEUE_ADPTV_QOS_RX_QCFG_CMD_ERR_CODE_LAST             QUEUE_ADPTV_QOS_RX_QCFG_CMD_ERR_CODE_GET_CONFIG_FAILED
	u8	unused_0[7];
};

/* queue_adptv_qos_rx_info (size:832b/104B) */
struct queue_adptv_qos_rx_info {
	__le16	rx_shared_pool_cells;
	__le16	rx_total_cells;
	u8	rx_cell_size;
	u8	rx_enabled_cos;
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ENABLED_COS0     0x1UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ENABLED_COS1     0x2UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ENABLED_COS2     0x4UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ENABLED_COS3     0x8UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ENABLED_COS4     0x10UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ENABLED_COS5     0x20UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ENABLED_COS6     0x40UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ENABLED_COS7     0x80UL
	u8	rx_llfc_enabled;
	u8	rx_pfc_enabled_cos;
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_PFC_ENABLED_COS0     0x1UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_PFC_ENABLED_COS1     0x2UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_PFC_ENABLED_COS2     0x4UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_PFC_ENABLED_COS3     0x8UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_PFC_ENABLED_COS4     0x10UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_PFC_ENABLED_COS5     0x20UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_PFC_ENABLED_COS6     0x40UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_PFC_ENABLED_COS7     0x80UL
	__le16	rx_reserved_cells_cos[8];
	__le16	rx_shared_cells_cos[8];
	__le16	rx_shared_combined_cells_cos[8];
	__le16	rx_headroom_cells_cos[8];
	__le16	rx_headroom_combined_cells_cos[8];
	u8	rx_shared_pool_index_cos[8];
	u8	rx_roce_enabled_cos;
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ROCE_ENABLED_COS0     0x1UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ROCE_ENABLED_COS1     0x2UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ROCE_ENABLED_COS2     0x4UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ROCE_ENABLED_COS3     0x8UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ROCE_ENABLED_COS4     0x10UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ROCE_ENABLED_COS5     0x20UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ROCE_ENABLED_COS6     0x40UL
	#define QUEUE_ADPTV_QOS_RX_INFO_RX_ROCE_ENABLED_COS7     0x80UL
	u8	unused_0[7];
};

/* hwrm_queue_adptv_qos_tx_qcfg_input (size:256b/32B) */
struct hwrm_queue_adptv_qos_tx_qcfg_input {
	__le16	req_type;
	__le16	cmpl_ring;
	__le16	seq_id;
	__le16	target_id;
	__le64	resp_addr;
	__le32	tx_qcfg_host_addr[2];
	__le16	tx_qcfg_size;
	u8	port_id;
	u8	unused_0[5];
};

/* hwrm_queue_adptv_qos_tx_qcfg_output (size:128b/16B) */
struct hwrm_queue_adptv_qos_tx_qcfg_output {
	__le16	error_code;
	__le16	req_type;
	__le16	seq_id;
	__le16	resp_len;
...
/* hwrm_queue_adptv_qos_tx_qcfg_cmd_err (size:64b/8B) */
struct hwrm_queue_adptv_qos_tx_qcfg_cmd_err {
	u8	code;
	#define QUEUE_ADPTV_QOS_TX_QCFG_CMD_ERR_CODE_UNKNOWN           0x0UL
	#define QUEUE_ADPTV_QOS_TX_QCFG_CMD_ERR_CODE_INVALID_PORT_ID   0x1UL
	#define QUEUE_ADPTV_QOS_TX_QCFG_CMD_ERR_CODE_NO_MEM            0x2UL
	#define QUEUE_ADPTV_QOS_TX_QCFG_CMD_ERR_CODE_GET_CONFIG_FAILED 0x3UL
	#define QUEUE_ADPTV_QOS_TX_QCFG_CMD_ERR_CODE_LAST             QUEUE_ADPTV_QOS_TX_QCFG_CMD_ERR_CODE_GET_CONFIG_FAILED
	u8	unused_0[7];
};

/* queue_adptv_qos_tx_info (size:512b/64B) */
struct queue_adptv_qos_tx_info {
	__le16	tx_shared_pool_cells;
	__le16	tx_total_cells;
	u8	tx_cell_size;
	u8	tx_enabled_cos;
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ENABLED_COS0     0x1UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ENABLED_COS1     0x2UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ENABLED_COS2     0x4UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ENABLED_COS3     0x8UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ENABLED_COS4     0x10UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ENABLED_COS5     0x20UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ENABLED_COS6     0x40UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ENABLED_COS7     0x80UL
	u8	tx_roce_enabled_cos;
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ROCE_ENABLED_COS0     0x1UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ROCE_ENABLED_COS1     0x2UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ROCE_ENABLED_COS2     0x4UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ROCE_ENABLED_COS3     0x8UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ROCE_ENABLED_COS4     0x10UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ROCE_ENABLED_COS5     0x20UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ROCE_ENABLED_COS6     0x40UL
	#define QUEUE_ADPTV_QOS_TX_INFO_TX_ROCE_ENABLED_COS7     0x80UL
	u8	unused_0;
	__le16	tx_reserved_cells_cos[8];
	__le16	tx_shared_cells_cos[8];
	__le16	tx_shared_combined_cells_cos[8];
	u8	tx_shared_pool_index_cos[8];
};
...
/* hwrm_vnic_alloc_cmd_err (size:64b/8B) */
struct hwrm_vnic_alloc_cmd_err {
	u8	code;
	#define VNIC_ALLOC_CMD_ERR_CODE_UNKNOWN                       0x0UL
	#define VNIC_ALLOC_CMD_ERR_CODE_RESOURCE_ALLOC_INVALID_PARAMS 0x1UL
	#define VNIC_ALLOC_CMD_ERR_CODE_OUT_OF_VNIC_RESOURCES         0x2UL
	#define VNIC_ALLOC_CMD_ERR_CODE_VNIC_SETUP_FAILED             0x3UL
	#define VNIC_ALLOC_CMD_ERR_CODE_VNIC_SET_CONTEXT_FAIL         0x4UL
	#define VNIC_ALLOC_CMD_ERR_CODE_LAST                         VNIC_ALLOC_CMD_ERR_CODE_VNIC_SET_CONTEXT_FAIL
	u8	unused_0[7];
};
...
/* hwrm_vnic_update_cmd_err (size:64b/8B) */
struct hwrm_vnic_update_cmd_err {
	u8	code;
	#define VNIC_UPDATE_CMD_ERR_CODE_UNKNOWN                 0x0UL
	#define VNIC_UPDATE_CMD_ERR_CODE_VNIC_INVALID            0x1UL
	#define VNIC_UPDATE_CMD_ERR_CODE_CTX_INVALID             0x2UL
	#define VNIC_UPDATE_CMD_ERR_CODE_CTX_CFG_ERR             0x3UL
	#define VNIC_UPDATE_CMD_ERR_CODE_INVALID_METADATA_FORMAT 0x4UL
	#define VNIC_UPDATE_CMD_ERR_CODE_LAST                   VNIC_UPDATE_CMD_ERR_CODE_INVALID_METADATA_FORMAT
	u8	unused_0[7];
};
...
/* hwrm_vnic_cfg_cmd_err (size:64b/8B) */
struct hwrm_vnic_cfg_cmd_err {
	u8	code;
	#define VNIC_CFG_CMD_ERR_CODE_UNKNOWN                 0x0UL
	#define VNIC_CFG_CMD_ERR_CODE_VNIC_INVALID            0x1UL
	#define VNIC_CFG_CMD_ERR_CODE_CTX_INVALID             0x2UL
	#define VNIC_CFG_CMD_ERR_CODE_CTX_CFG_ERR             0x3UL
	#define VNIC_CFG_CMD_ERR_CODE_RX_CSUM_V2_MODE_INVALID 0x4UL
	#define VNIC_CFG_CMD_ERR_CODE_L2_CQE_MODE_INVALID     0x5UL
	#define VNIC_CFG_CMD_ERR_CODE_ROCE_VNIC_ALLOC_FAILED  0x6UL
	#define VNIC_CFG_CMD_ERR_CODE_VNIC_SETUP_FAILED       0x7UL
	#define VNIC_CFG_CMD_ERR_CODE_HW_CFG_RX_RING_ERR      0x8UL
	#define VNIC_CFG_CMD_ERR_CODE_HW_CFG_CMPL_RING_ERR    0x9UL
	#define VNIC_CFG_CMD_ERR_CODE_LAST                   VNIC_CFG_CMD_ERR_CODE_HW_CFG_CMPL_RING_ERR
	u8	unused_0[7];
};
...
/* hwrm_vnic_qcfg_cmd_err (size:64b/8B) */
struct hwrm_vnic_qcfg_cmd_err {
	u8	code;
	#define VNIC_QCFG_CMD_ERR_CODE_UNKNOWN          0x0UL
	#define VNIC_QCFG_CMD_ERR_CODE_VNIC_INVALID     0x1UL
	#define VNIC_QCFG_CMD_ERR_CODE_QUEUE_ID_INVALID 0x2UL
	#define VNIC_QCFG_CMD_ERR_CODE_LAST            VNIC_QCFG_CMD_ERR_CODE_QUEUE_ID_INVALID
	u8	unused_0[7];
};
...
/* hwrm_vnic_tpa_cfg_cmd_err (size:64b/8B) */
struct hwrm_vnic_tpa_cfg_cmd_err {
	u8	code;
	#define VNIC_TPA_CFG_CMD_ERR_CODE_UNKNOWN         0x0UL
	#define VNIC_TPA_CFG_CMD_ERR_CODE_VNIC_INVALID    0x1UL
	#define VNIC_TPA_CFG_CMD_ERR_CODE_CTX_INVALID     0x2UL
	#define VNIC_TPA_CFG_CMD_ERR_CODE_CTX_TPA_CFG_ERR 0x3UL
	#define VNIC_TPA_CFG_CMD_ERR_CODE_LAST           VNIC_TPA_CFG_CMD_ERR_CODE_CTX_TPA_CFG_ERR
	u8	unused_0[7];
};
...
/* hwrm_vnic_tpa_qcfg_cmd_err (size:64b/8B) */
struct hwrm_vnic_tpa_qcfg_cmd_err {
	u8	code;
	#define VNIC_TPA_QCFG_CMD_ERR_CODE_UNKNOWN          0x0UL
	#define VNIC_TPA_QCFG_CMD_ERR_CODE_VNIC_INVALID     0x1UL
	#define VNIC_TPA_QCFG_CMD_ERR_CODE_CTX_INVALID      0x2UL
	#define VNIC_TPA_QCFG_CMD_ERR_CODE_CTX_TPA_QCFG_ERR 0x3UL
	#define VNIC_TPA_QCFG_CMD_ERR_CODE_LAST            VNIC_TPA_QCFG_CMD_ERR_CODE_CTX_TPA_QCFG_ERR
	u8	unused_0[7];
};
...
/* hwrm_vnic_rss_qcfg_cmd_err (size:64b/8B) */
struct hwrm_vnic_rss_qcfg_cmd_err {
	u8	code;
	#define VNIC_RSS_QCFG_CMD_ERR_CODE_UNKNOWN          0x0UL
	#define VNIC_RSS_QCFG_CMD_ERR_CODE_VNIC_INVALID     0x1UL
	#define VNIC_RSS_QCFG_CMD_ERR_CODE_CTX_INVALID      0x2UL
	#define VNIC_RSS_QCFG_CMD_ERR_CODE_CTX_RSS_QCFG_ERR 0x3UL
	#define VNIC_RSS_QCFG_CMD_ERR_CODE_LAST            VNIC_RSS_QCFG_CMD_ERR_CODE_CTX_RSS_QCFG_ERR
	u8	unused_0[7];
};
...
/* hwrm_vnic_rss_cos_lb_ctx_alloc_cmd_err (size:64b/8B) */
struct hwrm_vnic_rss_cos_lb_ctx_alloc_cmd_err {
	u8	code;
	#define VNIC_RSS_COS_LB_CTX_ALLOC_CMD_ERR_CODE_UNKNOWN          0x0UL
	#define VNIC_RSS_COS_LB_CTX_ALLOC_CMD_ERR_CODE_OUT_OF_MEM       0x1UL
	#define VNIC_RSS_COS_LB_CTX_ALLOC_CMD_ERR_CODE_CTX_ALLOC_FAIL   0x2UL
	#define VNIC_RSS_COS_LB_CTX_ALLOC_CMD_ERR_CODE_RESRC_ALLOC_FAIL 0x3UL
	#define VNIC_RSS_COS_LB_CTX_ALLOC_CMD_ERR_CODE_LAST            VNIC_RSS_COS_LB_CTX_ALLOC_CMD_ERR_CODE_RESRC_ALLOC_FAIL
	u8	unused_0[7];
};
...
/* hwrm_ring_alloc_cmd_err (size:64b/8B) */
struct hwrm_ring_alloc_cmd_err {
	u8	code;
	#define RING_ALLOC_CMD_ERR_CODE_UNKNOWN                0x0UL
	#define RING_ALLOC_CMD_ERR_CODE_BAD_PG_SIZE            0x1UL
	#define RING_ALLOC_CMD_ERR_CODE_BAD_ADDR_ALIGNMENT     0x2UL
	#define RING_ALLOC_CMD_ERR_CODE_BAD_FBO_ALIGNMENT      0x3UL
	#define RING_ALLOC_CMD_ERR_CODE_BAD_STAT_XID           0x4UL
	#define RING_ALLOC_CMD_ERR_CODE_NO_RESOURCE_FOR_VF     0x5UL
	#define RING_ALLOC_CMD_ERR_CODE_NO_RESOURCE_FOR_PF     0x6UL
	#define RING_ALLOC_CMD_ERR_CODE_RESMGR_RESRV_FAIL      0x7UL
	#define RING_ALLOC_CMD_ERR_CODE_GET_TQM_RING_FAIL      0x8UL
	#define RING_ALLOC_CMD_ERR_CODE_CTX_ALLOC_FAIL         0x9UL
	#define RING_ALLOC_CMD_ERR_CODE_RESMGR_ALLOC_FAIL      0xaUL
	#define RING_ALLOC_CMD_ERR_CODE_NO_PRIMARY_RX_RING     0xbUL
	#define RING_ALLOC_CMD_ERR_CODE_NQ_RING_ALLOC_FAIL     0xcUL
	#define RING_ALLOC_CMD_ERR_CODE_NQ_RING_ENABLE_FAIL    0xdUL
	#define RING_ALLOC_CMD_ERR_CODE_ALLOC_CQ_FOR_NQ_FAIL   0xeUL
	#define RING_ALLOC_CMD_ERR_CODE_INVALID_NQ_RING_FOR_CQ 0xfUL
	#define RING_ALLOC_CMD_ERR_CODE_NO_STAT_ID             0x10UL
	#define RING_ALLOC_CMD_ERR_CODE_LAST                  RING_ALLOC_CMD_ERR_CODE_NO_STAT_ID
	u8	unused_0[7];
};
...
/* hwrm_ring_free_cmd_err (size:64b/8B) */
struct hwrm_ring_free_cmd_err {
	u8	code;
	#define RING_FREE_CMD_ERR_CODE_UNKNOWN              0x0UL
	#define RING_FREE_CMD_ERR_CODE_GET_SEMAPHORE_FAIL   0x1UL
	#define RING_FREE_CMD_ERR_CODE_CMPL_RING_FREE_FAIL  0x2UL
	#define RING_FREE_CMD_ERR_CODE_NQ_RING_FREE_FAIL    0x3UL
	#define RING_FREE_CMD_ERR_CODE_NO_NQ_RING_ALLOCATED 0x4UL
	#define RING_FREE_CMD_ERR_CODE_NO_RING_ALLOCATED    0x5UL
	#define RING_FREE_CMD_ERR_CODE_LAST                RING_FREE_CMD_ERR_CODE_NO_RING_ALLOCATED
	u8	unused_0[7];
};
...
/* hwrm_ring_cfg_cmd_err (size:64b/8B) */
struct hwrm_ring_cfg_cmd_err {
	u8	code;
	#define RING_CFG_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define RING_CFG_CMD_ERR_CODE_CFG_TX_RING_FAIL   0x1UL
	#define RING_CFG_CMD_ERR_CODE_SCHQ_RING_CFG_FAIL 0x2UL
	#define RING_CFG_CMD_ERR_CODE_CFG_RX_RING_FAIL   0x3UL
	#define RING_CFG_CMD_ERR_CODE_INVALID_PARAMS     0x4UL
	#define RING_CFG_CMD_ERR_CODE_LAST              RING_CFG_CMD_ERR_CODE_INVALID_PARAMS
	u8	unused_0[7];
};
...
/* hwrm_ring_qcfg_cmd_err (size:64b/8B) */
struct hwrm_ring_qcfg_cmd_err {
	u8	code;
	#define RING_QCFG_CMD_ERR_CODE_UNKNOWN           0x0UL
	#define RING_QCFG_CMD_ERR_CODE_QCFG_TX_RING_FAIL 0x1UL
	#define RING_QCFG_CMD_ERR_CODE_QCFG_RX_RING_FAIL 0x2UL
	#define RING_QCFG_CMD_ERR_CODE_INVALID_PARAMS    0x4UL
	#define RING_QCFG_CMD_ERR_CODE_LAST             RING_QCFG_CMD_ERR_CODE_INVALID_PARAMS
	u8	unused_0[7];
};
...
/* hwrm_ring_cmpl_ring_qaggint_params_cmd_err (size:64b/8B) */
struct hwrm_ring_cmpl_ring_qaggint_params_cmd_err {
	u8	code;
	#define RING_CMPL_RING_QAGGINT_PARAMS_CMD_ERR_CODE_UNKNOWN    0x0UL
	#define RING_CMPL_RING_QAGGINT_PARAMS_CMD_ERR_CODE_COAL_PARAM 0x1UL
	#define RING_CMPL_RING_QAGGINT_PARAMS_CMD_ERR_CODE_NQ_ID      0x2UL
	#define RING_CMPL_RING_QAGGINT_PARAMS_CMD_ERR_CODE_MINTIMER   0x3UL
	#define RING_CMPL_RING_QAGGINT_PARAMS_CMD_ERR_CODE_LAST      RING_CMPL_RING_QAGGINT_PARAMS_CMD_ERR_CODE_MINTIMER
	u8	unused_0[7];
};
...
/* hwrm_ring_cmpl_ring_cfg_aggint_params_cmd_err (size:64b/8B) */
struct hwrm_ring_cmpl_ring_cfg_aggint_params_cmd_err {
	u8	code;
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_UNKNOWN   0x0UL
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_PARAMETER 0x1UL
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_MIN_TMR   0x2UL
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_SETMINTMR 0x3UL
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_NO_ENABLE 0x4UL
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_GET_COAL  0x5UL
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_DMA_AGGR  0x6UL
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_DMAAGRINT 0x7UL
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_DMA_TMR   0x8UL
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_LAT_TMR   0x9UL
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_AGGR_INT  0xaUL
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_SET_COAL  0xbUL
	#define RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_LAST     RING_CMPL_RING_CFG_AGGINT_PARAMS_CMD_ERR_CODE_SET_COAL
	u8	unused_0[7];
};
...
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_UNKNOWN            0x0UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_ZERO_MAC           0x65UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_BC_MC_MAC          0x66UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_INVALID_VNIC       0x67UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_INVALID_PF_FID     0x68UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_INVALID_L2_CTXT_ID 0x69UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_NULL_L2_CTXT_CFG   0x6aUL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_NULL_L2_DATA_FLD   0x6bUL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_INVALID_CFA_LAYOUT 0x6cUL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_L2_CTXT_ALLOC_FAIL 0x6dUL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_ROCE_FLOW_ERR      0x6eUL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_INVALID_OWNER_FID  0x6fUL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_ZERO_REF_CNT       0x70UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_INVALID_FLOW_TYPE  0x71UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_INVALID_IVLAN      0x72UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_MAX_VLAN_ID        0x73UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_INVALID_TNL_REQ    0x74UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_L2_ADDR            0x75UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_L2_IVLAN           0x76UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_L3_ADDR            0x77UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_L3_ADDR_TYPE       0x78UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_T_L3_ADDR_TYPE     0x79UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_DST_VNIC_ID        0x7aUL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_VNI                0x7bUL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_INVALID_DST_ID     0x7cUL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_FAIL_ROCE_L2_FLOW  0x7dUL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_INVALID_NPAR_VLAN  0x7eUL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_ATSP_ADD           0x7fUL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_DFLT_VLAN_FAIL     0x80UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_INVALID_L3_TYPE    0x81UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_VAL_FAIL_TNL_FLOW  0x82UL
#define HWRM_CFA_FILTER_COMMON_CMD_ERR_LAST              HWRM_CFA_FILTER_COMMON_CMD_ERR_VAL_FAIL_TNL_FLOW
...
/* hwrm_cfa_l2_filter_alloc_cmd_err (size:64b/8B) */
struct hwrm_cfa_l2_filter_alloc_cmd_err {
	u8	code;
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_ZERO_MAC           0x65UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_BC_MC_MAC          0x66UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_INVALID_VNIC       0x67UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_INVALID_PF_FID     0x68UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_INVALID_L2_CTXT_ID 0x69UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_NULL_L2_CTXT_CFG   0x6aUL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_NULL_L2_DATA_FLD   0x6bUL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_INVALID_CFA_LAYOUT 0x6cUL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_L2_CTXT_ALLOC_FAIL 0x6dUL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_ROCE_FLOW_ERR      0x6eUL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_INVALID_OWNER_FID  0x6fUL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_ZERO_REF_CNT       0x70UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_INVALID_FLOW_TYPE  0x71UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_INVALID_IVLAN      0x72UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_MAX_VLAN_ID        0x73UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_INVALID_TNL_REQ    0x74UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_L2_ADDR            0x75UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_L2_IVLAN           0x76UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_L3_ADDR            0x77UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_L3_ADDR_TYPE       0x78UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_T_L3_ADDR_TYPE     0x79UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_DST_VNIC_ID        0x7aUL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_VNI                0x7bUL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_INVALID_DST_ID     0x7cUL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_FAIL_ROCE_L2_FLOW  0x7dUL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_INVALID_NPAR_VLAN  0x7eUL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_ATSP_ADD           0x7fUL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_DFLT_VLAN_FAIL     0x80UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_INVALID_L3_TYPE    0x81UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_VAL_FAIL_TNL_FLOW  0x82UL
	#define CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_LAST              CFA_L2_FILTER_ALLOC_CMD_ERR_CODE_VAL_FAIL_TNL_FLOW
	u8	unused_0[7];
};
...
/* hwrm_cfa_l2_filter_cfg_cmd_err (size:64b/8B) */
struct hwrm_cfa_l2_filter_cfg_cmd_err {
	u8	code;
	#define CFA_L2_FILTER_CFG_CMD_ERR_CODE_UNKNOWN     0x0UL
	#define CFA_L2_FILTER_CFG_CMD_ERR_CODE_INVALID_FID 0x1UL
	#define CFA_L2_FILTER_CFG_CMD_ERR_CODE_LAST       CFA_L2_FILTER_CFG_CMD_ERR_CODE_INVALID_FID
	u8	unused_0[7];
};
...
/* hwrm_cfa_tunnel_filter_alloc_cmd_err (size:64b/8B) */
struct hwrm_cfa_tunnel_filter_alloc_cmd_err {
	u8	code;
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_ZERO_MAC           0x65UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_BC_MC_MAC          0x66UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_INVALID_VNIC       0x67UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_INVALID_PF_FID     0x68UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_INVALID_L2_CTXT_ID 0x69UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_NULL_L2_CTXT_CFG   0x6aUL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_NULL_L2_DATA_FLD   0x6bUL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_INVALID_CFA_LAYOUT 0x6cUL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_L2_CTXT_ALLOC_FAIL 0x6dUL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_ROCE_FLOW_ERR      0x6eUL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_INVALID_OWNER_FID  0x6fUL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_ZERO_REF_CNT       0x70UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_INVALID_FLOW_TYPE  0x71UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_INVALID_IVLAN      0x72UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_MAX_VLAN_ID        0x73UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_INVALID_TNL_REQ    0x74UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_L2_ADDR            0x75UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_L2_IVLAN           0x76UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_L3_ADDR            0x77UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_L3_ADDR_TYPE       0x78UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_T_L3_ADDR_TYPE     0x79UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_DST_VNIC_ID        0x7aUL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_VNI                0x7bUL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_INVALID_DST_ID     0x7cUL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_FAIL_ROCE_L2_FLOW  0x7dUL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_INVALID_NPAR_VLAN  0x7eUL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_ATSP_ADD           0x7fUL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_DFLT_VLAN_FAIL     0x80UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_INVALID_L3_TYPE    0x81UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_VAL_FAIL_TNL_FLOW  0x82UL
	#define CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_LAST              CFA_TUNNEL_FILTER_ALLOC_CMD_ERR_CODE_VAL_FAIL_TNL_FLOW
	u8	unused_0[7];
};
...
/* hwrm_cfa_tunnel_filter_free_cmd_err (size:64b/8B) */
struct hwrm_cfa_tunnel_filter_free_cmd_err {
	u8	code;
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_ZERO_MAC           0x65UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_BC_MC_MAC          0x66UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_INVALID_VNIC       0x67UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_INVALID_PF_FID     0x68UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_INVALID_L2_CTXT_ID 0x69UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_NULL_L2_CTXT_CFG   0x6aUL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_NULL_L2_DATA_FLD   0x6bUL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_INVALID_CFA_LAYOUT 0x6cUL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_L2_CTXT_ALLOC_FAIL 0x6dUL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_ROCE_FLOW_ERR      0x6eUL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_INVALID_OWNER_FID  0x6fUL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_ZERO_REF_CNT       0x70UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_INVALID_FLOW_TYPE  0x71UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_INVALID_IVLAN      0x72UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_MAX_VLAN_ID        0x73UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_INVALID_TNL_REQ    0x74UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_L2_ADDR            0x75UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_L2_IVLAN           0x76UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_L3_ADDR            0x77UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_L3_ADDR_TYPE       0x78UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_T_L3_ADDR_TYPE     0x79UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_DST_VNIC_ID        0x7aUL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_VNI                0x7bUL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_INVALID_DST_ID     0x7cUL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_FAIL_ROCE_L2_FLOW  0x7dUL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_INVALID_NPAR_VLAN  0x7eUL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_ATSP_ADD           0x7fUL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_DFLT_VLAN_FAIL     0x80UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_INVALID_L3_TYPE    0x81UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_VAL_FAIL_TNL_FLOW  0x82UL
	#define CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_LAST              CFA_TUNNEL_FILTER_FREE_CMD_ERR_CODE_VAL_FAIL_TNL_FLOW
	u8	unused_0[7];
};
...
/* hwrm_cfa_ntuple_filter_free_cmd_err (size:64b/8B) */
struct hwrm_cfa_ntuple_filter_free_cmd_err {
	u8	code;
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_ZERO_MAC           0x65UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_BC_MC_MAC          0x66UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_INVALID_VNIC       0x67UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_INVALID_PF_FID     0x68UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_INVALID_L2_CTXT_ID 0x69UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_NULL_L2_CTXT_CFG   0x6aUL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_NULL_L2_DATA_FLD   0x6bUL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_INVALID_CFA_LAYOUT 0x6cUL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_L2_CTXT_ALLOC_FAIL 0x6dUL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_ROCE_FLOW_ERR      0x6eUL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_INVALID_OWNER_FID  0x6fUL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_ZERO_REF_CNT       0x70UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_INVALID_FLOW_TYPE  0x71UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_INVALID_IVLAN      0x72UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_MAX_VLAN_ID        0x73UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_INVALID_TNL_REQ    0x74UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_L2_ADDR            0x75UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_L2_IVLAN           0x76UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_L3_ADDR            0x77UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_L3_ADDR_TYPE       0x78UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_T_L3_ADDR_TYPE     0x79UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_DST_VNIC_ID        0x7aUL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_VNI                0x7bUL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_INVALID_DST_ID     0x7cUL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_FAIL_ROCE_L2_FLOW  0x7dUL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_INVALID_NPAR_VLAN  0x7eUL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_ATSP_ADD           0x7fUL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_DFLT_VLAN_FAIL     0x80UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_INVALID_L3_TYPE    0x81UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_VAL_FAIL_TNL_FLOW  0x82UL
	#define CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_LAST              CFA_NTUPLE_FILTER_FREE_CMD_ERR_CODE_VAL_FAIL_TNL_FLOW
	u8	unused_0[7];
};
...
/* hwrm_cfa_pair_alloc_cmd_err (size:64b/8B) */
struct hwrm_cfa_pair_alloc_cmd_err {
	u8	code;
	#define CFA_PAIR_ALLOC_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define CFA_PAIR_ALLOC_CMD_ERR_CODE_INVALID_VF_FID     0x1UL
	#define CFA_PAIR_ALLOC_CMD_ERR_CODE_FID_IS_PF          0x2UL
	#define CFA_PAIR_ALLOC_CMD_ERR_CODE_INVALID_VF_SW_ID   0x3UL
	#define CFA_PAIR_ALLOC_CMD_ERR_CODE_INVALID_FID        0x4UL
	#define CFA_PAIR_ALLOC_CMD_ERR_CODE_MAX_FW_DB_ENTRY    0x5UL
	#define CFA_PAIR_ALLOC_CMD_ERR_CODE_INVALID_PAIR_ENTRY 0x6UL
	#define CFA_PAIR_ALLOC_CMD_ERR_CODE_INVALID_PAIR_MODE  0x7UL
	#define CFA_PAIR_ALLOC_CMD_ERR_CODE_LAST              CFA_PAIR_ALLOC_CMD_ERR_CODE_INVALID_PAIR_MODE
	u8	unused_0[7];
};
...
/* hwrm_cfa_pair_free_cmd_err (size:64b/8B) */
struct hwrm_cfa_pair_free_cmd_err {
	u8	code;
	#define CFA_PAIR_FREE_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define CFA_PAIR_FREE_CMD_ERR_CODE_INVALID_PAIR_ENTRY 0x1UL
	#define CFA_PAIR_FREE_CMD_ERR_CODE_INVALID_VF_SW_ID   0x2UL
	#define CFA_PAIR_FREE_CMD_ERR_CODE_INVALID_DB_ENTRY   0x3UL
	#define CFA_PAIR_FREE_CMD_ERR_CODE_LAST              CFA_PAIR_FREE_CMD_ERR_CODE_INVALID_DB_ENTRY
	u8	unused_0[7];
};
...
/* hwrm_cfa_pair_info_cmd_err (size:64b/8B) */
struct hwrm_cfa_pair_info_cmd_err {
	u8	code;
	#define CFA_PAIR_INFO_CMD_ERR_CODE_UNKNOWN          0x0UL
	#define CFA_PAIR_INFO_CMD_ERR_CODE_INVALID_REQ_FLAG 0x1UL
	#define CFA_PAIR_INFO_CMD_ERR_CODE_LAST            CFA_PAIR_INFO_CMD_ERR_CODE_INVALID_REQ_FLAG
	u8	unused_0[7];
};
...
/* hwrm_cfa_tls_filter_alloc_cmd_err (size:64b/8B) */
struct hwrm_cfa_tls_filter_alloc_cmd_err {
	u8	code;
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_ZERO_MAC           0x65UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_BC_MC_MAC          0x66UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_INVALID_VNIC       0x67UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_INVALID_PF_FID     0x68UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_INVALID_L2_CTXT_ID 0x69UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_NULL_L2_CTXT_CFG   0x6aUL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_NULL_L2_DATA_FLD   0x6bUL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_INVALID_CFA_LAYOUT 0x6cUL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_L2_CTXT_ALLOC_FAIL 0x6dUL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_ROCE_FLOW_ERR      0x6eUL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_INVALID_OWNER_FID  0x6fUL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_ZERO_REF_CNT       0x70UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_INVALID_FLOW_TYPE  0x71UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_INVALID_IVLAN      0x72UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_MAX_VLAN_ID        0x73UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_INVALID_TNL_REQ    0x74UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_L2_ADDR            0x75UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_L2_IVLAN           0x76UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_L3_ADDR            0x77UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_L3_ADDR_TYPE       0x78UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_T_L3_ADDR_TYPE     0x79UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_DST_VNIC_ID        0x7aUL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_VNI                0x7bUL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_INVALID_DST_ID     0x7cUL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_FAIL_ROCE_L2_FLOW  0x7dUL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_INVALID_NPAR_VLAN  0x7eUL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_ATSP_ADD           0x7fUL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_DFLT_VLAN_FAIL     0x80UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_INVALID_L3_TYPE    0x81UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_VAL_FAIL_TNL_FLOW  0x82UL
	#define CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_LAST              CFA_TLS_FILTER_ALLOC_CMD_ERR_CODE_VAL_FAIL_TNL_FLOW
	u8	unused_0[7];
};
...
/* hwrm_cfa_tls_filter_free_cmd_err (size:64b/8B) */
struct hwrm_cfa_tls_filter_free_cmd_err {
	u8	code;
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_ZERO_MAC           0x65UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_BC_MC_MAC          0x66UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_INVALID_VNIC       0x67UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_INVALID_PF_FID     0x68UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_INVALID_L2_CTXT_ID 0x69UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_NULL_L2_CTXT_CFG   0x6aUL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_NULL_L2_DATA_FLD   0x6bUL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_INVALID_CFA_LAYOUT 0x6cUL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_L2_CTXT_ALLOC_FAIL 0x6dUL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_ROCE_FLOW_ERR      0x6eUL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_INVALID_OWNER_FID  0x6fUL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_ZERO_REF_CNT       0x70UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_INVALID_FLOW_TYPE  0x71UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_INVALID_IVLAN      0x72UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_MAX_VLAN_ID        0x73UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_INVALID_TNL_REQ    0x74UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_L2_ADDR            0x75UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_L2_IVLAN           0x76UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_L3_ADDR            0x77UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_L3_ADDR_TYPE       0x78UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_T_L3_ADDR_TYPE     0x79UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_DST_VNIC_ID        0x7aUL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_VNI                0x7bUL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_INVALID_DST_ID     0x7cUL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_FAIL_ROCE_L2_FLOW  0x7dUL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_INVALID_NPAR_VLAN  0x7eUL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_ATSP_ADD           0x7fUL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_DFLT_VLAN_FAIL     0x80UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_INVALID_L3_TYPE    0x81UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_VAL_FAIL_TNL_FLOW  0x82UL
	#define CFA_TLS_FILTER_FREE_CMD_ERR_CODE_LAST              CFA_TLS_FILTER_FREE_CMD_ERR_CODE_VAL_FAIL_TNL_FLOW
	u8	unused_0[7];
};
...
struct hwrm_tfc_tbl_scope_qcaps_output {
	...
	u8	flags;
	#define TFC_TBL_SCOPE_QCAPS_RESP_FLAGS_GLOBAL            0x1UL
	#define TFC_TBL_SCOPE_QCAPS_RESP_FLAGS_GLOBAL_UNSUPPORTED  0x0UL
	#define TFC_TBL_SCOPE_QCAPS_RESP_FLAGS_GLOBAL_SUPPORTED    0x1UL
	#define TFC_TBL_SCOPE_QCAPS_RESP_FLAGS_GLOBAL_LAST        TFC_TBL_SCOPE_QCAPS_RESP_FLAGS_GLOBAL_SUPPORTED
	#define TFC_TBL_SCOPE_QCAPS_RESP_FLAGS_LOCKED            0x2UL
	#define TFC_TBL_SCOPE_QCAPS_RESP_FLAGS_LOCKED_UNSUPPORTED  (0x0UL << 1)
	#define TFC_TBL_SCOPE_QCAPS_RESP_FLAGS_LOCKED_SUPPORTED    (0x1UL << 1)
	#define TFC_TBL_SCOPE_QCAPS_RESP_FLAGS_LOCKED_LAST        TFC_TBL_SCOPE_QCAPS_RESP_FLAGS_LOCKED_SUPPORTED
	u8	unused0[4];
	u8	valid;
};
...
struct hwrm_tfc_tbl_scope_id_alloc_input {
	...
	u8	app_type;
	u8	scope_type;
	#define TFC_TBL_SCOPE_ID_ALLOC_REQ_SCOPE_TYPE_NON_SHARED 0x1UL
	#define TFC_TBL_SCOPE_ID_ALLOC_REQ_SCOPE_TYPE_SHARED_APP 0x2UL
	#define TFC_TBL_SCOPE_ID_ALLOC_REQ_SCOPE_TYPE_GLOBAL     0x3UL
	#define TFC_TBL_SCOPE_ID_ALLOC_REQ_SCOPE_TYPE_LAST      TFC_TBL_SCOPE_ID_ALLOC_REQ_SCOPE_TYPE_GLOBAL
	u8	unused0[5];
};
...
struct hwrm_tfc_global_id_alloc_input {
	...
	u8	subtype;
	u8	flags;
	#define TFC_GLOBAL_ID_ALLOC_REQ_FLAGS_DIR     0x1UL
	#define TFC_GLOBAL_ID_ALLOC_REQ_FLAGS_DIR_RX    0x0UL
	#define TFC_GLOBAL_ID_ALLOC_REQ_FLAGS_DIR_TX    0x1UL
	#define TFC_GLOBAL_ID_ALLOC_REQ_FLAGS_DIR_LAST TFC_GLOBAL_ID_ALLOC_REQ_FLAGS_DIR_TX
	u8	context_id[16];
};
...
struct hwrm_tfc_global_id_free_input {
	__le16	req_type;
	__le16	cmpl_ring;
	__le16	seq_id;
	__le16	target_id;
...
struct hwrm_tfc_global_id_free_output {
	__le16	error_code;
	__le16	req_type;
	__le16	seq_id;
	__le16	resp_len;
...
struct hwrm_tfc_tcam_pri_update_input {
	...
	__le16	priority;
	u8	flags;
	#define TFC_TCAM_PRI_UPDATE_REQ_FLAGS_DIR     0x1UL
	#define TFC_TCAM_PRI_UPDATE_REQ_FLAGS_DIR_RX    0x0UL
	#define TFC_TCAM_PRI_UPDATE_REQ_FLAGS_DIR_TX    0x1UL
	#define TFC_TCAM_PRI_UPDATE_REQ_FLAGS_DIR_LAST TFC_TCAM_PRI_UPDATE_REQ_FLAGS_DIR_TX
	u8	subtype;
	u8	track_type;
	#define TFC_TCAM_PRI_UPDATE_REQ_TRACK_TYPE_TRACK_TYPE_INVALID 0x0UL
	#define TFC_TCAM_PRI_UPDATE_REQ_TRACK_TYPE_TRACK_TYPE_SID     0x1UL
	#define TFC_TCAM_PRI_UPDATE_REQ_TRACK_TYPE_TRACK_TYPE_FID     0x2UL
	#define TFC_TCAM_PRI_UPDATE_REQ_TRACK_TYPE_LAST              TFC_TCAM_PRI_UPDATE_REQ_TRACK_TYPE_TRACK_TYPE_FID
	u8	unused0[5];
};
...
struct hwrm_tfc_hot_upgrade_process_input {
	...
	u8	app_id;
	u8	cmd;
	#define TFC_HOT_UPGRADE_PROCESS_REQ_CMD_ALLOC     0x1UL
	#define TFC_HOT_UPGRADE_PROCESS_REQ_CMD_FREE      0x2UL
	#define TFC_HOT_UPGRADE_PROCESS_REQ_CMD_GET       0x4UL
	#define TFC_HOT_UPGRADE_PROCESS_REQ_CMD_SET       0x8UL
	u8	cur_session_cnt;
	u8	unused0;
};
...
/* hwrm_tunnel_dst_port_query_cmd_err (size:64b/8B) */
struct hwrm_tunnel_dst_port_query_cmd_err {
	u8	code;
	#define TUNNEL_DST_PORT_QUERY_CMD_ERR_UNKNOWN         0x0UL
	#define TUNNEL_DST_PORT_QUERY_CMD_ERR_GET_PORT_FAILED 0x1UL
	#define TUNNEL_DST_PORT_QUERY_CMD_ERR_LAST           TUNNEL_DST_PORT_QUERY_CMD_ERR_GET_PORT_FAILED
	u8	unused_0[7];
};
...
/* hwrm_tunnel_dst_port_free_cmd_err (size:64b/8B) */
struct hwrm_tunnel_dst_port_free_cmd_err {
	u8	code;
	#define TUNNEL_DST_PORT_FREE_CMD_ERR_UNKNOWN                 0x0UL
	#define TUNNEL_DST_PORT_FREE_CMD_ERR_TUNNEL_FREE_FAILED      0x1UL
	#define TUNNEL_DST_PORT_FREE_CMD_ERR_CUSTOM_TUNNEL_NOT_FOUND 0x2UL
	#define TUNNEL_DST_PORT_FREE_CMD_ERR_GET_PORT_FAILED         0x3UL
	#define TUNNEL_DST_PORT_FREE_CMD_ERR_PORT_NUM_ERR            0x4UL
	#define TUNNEL_DST_PORT_FREE_CMD_ERR_GRE_NOT_OWNER           0x5UL
	#define TUNNEL_DST_PORT_FREE_CMD_ERR_TUNNEL_TYPE_INVALID     0x6UL
	#define TUNNEL_DST_PORT_FREE_CMD_ERR_CUSTOM_GRE_UNSUPPORTED  0x7UL
	#define TUNNEL_DST_PORT_FREE_CMD_ERR_GRE_MODE_UNSUPPORTED    0x8UL
	#define TUNNEL_DST_PORT_FREE_CMD_ERR_ACCESS_DENIED           0x9UL
	#define TUNNEL_DST_PORT_FREE_CMD_ERR_UPAR_ERR                0xaUL
	#define TUNNEL_DST_PORT_FREE_CMD_ERR_LAST                   TUNNEL_DST_PORT_FREE_CMD_ERR_UPAR_ERR
	u8	unused_0[7];
};
...
/* hwrm_struct_data_udcc_rtt_bucket_count (size:64b/8B) */
struct hwrm_struct_data_udcc_rtt_bucket_count {
	u8	bucket_idx;
	u8	unused[3];
	__le32	count;
};

/* hwrm_struct_data_udcc_rtt_bucket_bound (size:64b/8B) */
struct hwrm_struct_data_udcc_rtt_bucket_bound {
	u8	bucket_idx;
	u8	unused[3];
	__le32	bound;
};
...
/* hwrm_dbg_ring_info_get_cmd_err (size:64b/8B) */
struct hwrm_dbg_ring_info_get_cmd_err {
	u8	code;
	#define DBG_RING_INFO_GET_CMD_ERR_CODE_UNKNOWN                 0x0UL
	#define DBG_RING_INFO_GET_CMD_ERR_CODE_CMPL_RING_NOT_ALLOCATED 0x1UL
	#define DBG_RING_INFO_GET_CMD_ERR_CODE_TX_RING_NOT_ALLOCATED   0x2UL
	#define DBG_RING_INFO_GET_CMD_ERR_CODE_RX_RING_NOT_ALLOCATED   0x3UL
	#define DBG_RING_INFO_GET_CMD_ERR_CODE_INVALID_NQ_FW_RING_ID   0x4UL
	#define DBG_RING_INFO_GET_CMD_ERR_CODE_GET_CTX_FAIL            0x5UL
	#define DBG_RING_INFO_GET_CMD_ERR_CODE_INVALID_RING_TYPE       0x6UL
	#define DBG_RING_INFO_GET_CMD_ERR_CODE_LAST                   DBG_RING_INFO_GET_CMD_ERR_CODE_INVALID_RING_TYPE
	u8	unused_0[7];
};
...
/* hwrm_dbg_token_query_auth_ids_input (size:128b/16B) */
struct hwrm_dbg_token_query_auth_ids_input {
	__le16	req_type;
	__le16	cmpl_ring;
	__le16	seq_id;
	__le16	target_id;
...
/* hwrm_dbg_token_query_auth_ids_output (size:704b/88B) */
struct hwrm_dbg_token_query_auth_ids_output {
	__le16	error_code;
	__le16	req_type;
	__le16	seq_id;
	__le16	resp_len;
...
struct hwrm_nvm_validate_option_cmd_err {
	...
	#define NVM_VALIDATE_OPTION_CMD_ERR_CODE_INVALID_LEN   0x1UL
	#define NVM_VALIDATE_OPTION_CMD_ERR_CODE_VAR_NOT_EXIST 0x2UL
	#define NVM_VALIDATE_OPTION_CMD_ERR_CODE_LAST         NVM_VALIDATE_OPTION_CMD_ERR_CODE_VAR_NOT_EXIST
	u8	unused_0[7];
};
...
struct hwrm_nvm_factory_defaults_cmd_err {
	...
	#define NVM_FACTORY_DEFAULTS_CMD_ERR_CODE_INVALID_MODE 0x3UL
	#define NVM_FACTORY_DEFAULTS_CMD_ERR_CODE_LAST        NVM_FACTORY_DEFAULTS_CMD_ERR_CODE_INVALID_MODE
	u8	unused_0[7];
};
...
struct hwrm_udcc_qcaps_output {
	...
	#define UDCC_QCAPS_RESP_FLAGS_RTT_DISTRIBUTION_SUPPORTED     0x2UL
	#define UDCC_QCAPS_RESP_FLAGS_IFA_PROBE_SUPPORTED            0x4UL
...
/* hwrm_udcc_cfg_input (size:256b/32B) */
struct hwrm_udcc_cfg_input {
	...
	#define UDCC_CFG_REQ_ENABLES_PROBE_PAD_CNT_CFG       0x2UL
	#define UDCC_CFG_REQ_ENABLES_UDCC_HYBRID_MODE        0x4UL
	#define UDCC_CFG_REQ_ENABLES_PROBE_FORMAT            0x8UL
	#define UDCC_CFG_REQ_ENABLES_PROBE_IFA_GNS           0x10UL
	#define UDCC_CFG_REQ_ENABLES_PROBE_IFA_HOP_LIMIT     0x20UL
	#define UDCC_CFG_REQ_ENABLES_PROBE_IFA_REQ_VEC       0x40UL
	u8	udcc_mode;
	...
	#define UDCC_CFG_REQ_PROBE_PAD_CNT_CFG_DISABLED 0x0UL
	#define UDCC_CFG_REQ_PROBE_PAD_CNT_CFG_ONE      0x1UL
	#define UDCC_CFG_REQ_PROBE_PAD_CNT_CFG_TWO      0x2UL
	#define UDCC_CFG_REQ_PROBE_PAD_CNT_CFG_THREE    0x3UL
	#define UDCC_CFG_REQ_PROBE_PAD_CNT_CFG_LAST    UDCC_CFG_REQ_PROBE_PAD_CNT_CFG_THREE
	u8	udcc_hybrid_mode;
	#define UDCC_CFG_REQ_UDCC_HYBRID_MODE_UDCC_ONLY       0x0UL
	#define UDCC_CFG_REQ_UDCC_HYBRID_MODE_UDCC_WITH_DCQCN 0x1UL
	#define UDCC_CFG_REQ_UDCC_HYBRID_MODE_LAST           UDCC_CFG_REQ_UDCC_HYBRID_MODE_UDCC_WITH_DCQCN
	u8	probe_format;
	#define UDCC_CFG_REQ_PROBE_FORMAT_MAD 0x0UL
	#define UDCC_CFG_REQ_PROBE_FORMAT_IFA 0x1UL
	#define UDCC_CFG_REQ_PROBE_FORMAT_LAST UDCC_CFG_REQ_PROBE_FORMAT_IFA
	u8	probe_ifa_gns;
	u8	probe_ifa_hop_limit;
	u8	probe_ifa_req_vec;
	u8	unused_1[5];
};
...
/* hwrm_udcc_cfg_cmd_err (size:64b/8B) */
struct hwrm_udcc_cfg_cmd_err {
	u8	code;
	#define UDCC_CFG_CMD_ERR_CODE_UNKNOWN                   0x0UL
	#define UDCC_CFG_CMD_ERR_CODE_INVALID_PROBE_PAD_CNT_CFG 0x1UL
	#define UDCC_CFG_CMD_ERR_CODE_INVALID_HYBRID_MODE       0x2UL
	#define UDCC_CFG_CMD_ERR_CODE_INVALID_PROBE_IFA_GNS     0x3UL
	#define UDCC_CFG_CMD_ERR_CODE_LAST                     UDCC_CFG_CMD_ERR_CODE_INVALID_PROBE_IFA_GNS
	u8	unused_0[7];
};
...
struct hwrm_udcc_qcfg_output {
	...
	u8	udcc_mode;
	u8	probe_pad_cnt_cfg;
	#define UDCC_QCFG_RESP_PROBE_PAD_CNT_CFG_DISABLED 0x0UL
	#define UDCC_QCFG_RESP_PROBE_PAD_CNT_CFG_ONE      0x1UL
	#define UDCC_QCFG_RESP_PROBE_PAD_CNT_CFG_TWO      0x2UL
	#define UDCC_QCFG_RESP_PROBE_PAD_CNT_CFG_THREE    0x3UL
	#define UDCC_QCFG_RESP_PROBE_PAD_CNT_CFG_LAST    UDCC_QCFG_RESP_PROBE_PAD_CNT_CFG_THREE
	u8	udcc_hybrid_mode;
	u8	probe_format;
	#define UDCC_QCFG_RESP_PROBE_FORMAT_MAD 0x0UL
	#define UDCC_QCFG_RESP_PROBE_FORMAT_IFA 0x1UL
	#define UDCC_QCFG_RESP_PROBE_FORMAT_LAST UDCC_QCFG_RESP_PROBE_FORMAT_IFA
	u8	probe_ifa_gns;
	u8	probe_ifa_hop_limit;
	u8	probe_ifa_req_vec;
	u8	valid;
...
struct hwrm_udcc_session_cfg_input {
	...
	u8	dest_mac[6];
	__le16	flags;
	#define UDCC_SESSION_CFG_REQ_FLAGS_RESET_RTT_COUNTS     0x1UL
	u8	src_mac[6];
	__le16	unused_3;
...
/* hwrm_udcc_session_cfg_cmd_err (size:64b/8B) */
struct hwrm_udcc_session_cfg_cmd_err {
	u8	code;
	#define UDCC_SESSION_CFG_CMD_ERR_CODE_UNKNOWN                0x0UL
	#define UDCC_SESSION_CFG_CMD_ERR_CODE_INVALID_SESSION_ID     0x1UL
	#define UDCC_SESSION_CFG_CMD_ERR_CODE_SESSION_NOT_IN_USE     0x2UL
	#define UDCC_SESSION_CFG_CMD_ERR_CODE_SESSION_CFG_STATE_FAIL 0x3UL
	#define UDCC_SESSION_CFG_CMD_ERR_CODE_INVALID_ENABLES        0x4UL
	#define UDCC_SESSION_CFG_CMD_ERR_CODE_SESSION_CFG_FAIL       0x5UL
	#define UDCC_SESSION_CFG_CMD_ERR_CODE_LAST                  UDCC_SESSION_CFG_CMD_ERR_CODE_SESSION_CFG_FAIL
	u8	unused_0[7];
};
...
/* hwrm_udcc_session_qcfg_cmd_err (size:64b/8B) */
struct hwrm_udcc_session_qcfg_cmd_err {
	u8	code;
	#define UDCC_SESSION_QCFG_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define UDCC_SESSION_QCFG_CMD_ERR_CODE_INVALID_SESSION_ID 0x1UL
	#define UDCC_SESSION_QCFG_CMD_ERR_CODE_SESSION_NOT_IN_USE 0x2UL
	#define UDCC_SESSION_QCFG_CMD_ERR_CODE_LAST              UDCC_SESSION_QCFG_CMD_ERR_CODE_SESSION_NOT_IN_USE
	u8	unused_0[7];
};
...
/* hwrm_udcc_session_query_cmd_err (size:64b/8B) */
struct hwrm_udcc_session_query_cmd_err {
	u8	code;
	#define UDCC_SESSION_QUERY_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define UDCC_SESSION_QUERY_CMD_ERR_CODE_INVALID_SESSION_ID 0x1UL
	#define UDCC_SESSION_QUERY_CMD_ERR_CODE_SESSION_NOT_IN_USE 0x2UL
	#define UDCC_SESSION_QUERY_CMD_ERR_CODE_LAST              UDCC_SESSION_QUERY_CMD_ERR_CODE_SESSION_NOT_IN_USE
	u8	unused_0[7];
};
...
/* hwrm_udcc_comp_cfg_cmd_err (size:64b/8B) */
struct hwrm_udcc_comp_cfg_cmd_err {
	u8	code;
	#define UDCC_COMP_CFG_CMD_ERR_CODE_UNKNOWN         0x0UL
	#define UDCC_COMP_CFG_CMD_ERR_CODE_INVALID_ARG_LEN 0x1UL
	#define UDCC_COMP_CFG_CMD_ERR_CODE_INVALID_CFG_LEN 0x2UL
	#define UDCC_COMP_CFG_CMD_ERR_CODE_LAST           UDCC_COMP_CFG_CMD_ERR_CODE_INVALID_CFG_LEN
	u8	unused_0[7];
};
...
/* hwrm_udcc_comp_qcfg_cmd_err (size:64b/8B) */
struct hwrm_udcc_comp_qcfg_cmd_err {
	u8	code;
	#define UDCC_COMP_QCFG_CMD_ERR_CODE_UNKNOWN         0x0UL
	#define UDCC_COMP_QCFG_CMD_ERR_CODE_INVALID_ARG_LEN 0x1UL
	#define UDCC_COMP_QCFG_CMD_ERR_CODE_INVALID_CFG_LEN 0x2UL
	#define UDCC_COMP_QCFG_CMD_ERR_CODE_LAST           UDCC_COMP_QCFG_CMD_ERR_CODE_INVALID_CFG_LEN
	u8	unused_0[7];
};
...
/* hwrm_udcc_comp_query_cmd_err (size:64b/8B) */
struct hwrm_udcc_comp_query_cmd_err {
	u8	code;
	#define UDCC_COMP_QUERY_CMD_ERR_CODE_UNKNOWN               0x0UL
	#define UDCC_COMP_QUERY_CMD_ERR_CODE_INVALID_ARG_LEN       0x1UL
	#define UDCC_COMP_QUERY_CMD_ERR_CODE_INVALID_HOST_BUF_SIZE 0x2UL
	#define UDCC_COMP_QUERY_CMD_ERR_CODE_LAST                 UDCC_COMP_QUERY_CMD_ERR_CODE_INVALID_HOST_BUF_SIZE
	u8	unused_0[7];
};
