...
#define IBV_CONFIG_DIR "/data2/upstream/libbnxt/tmp/v16/build/etc/libibverbs.d"
#define RS_CONF_DIR "/data2/upstream/libbnxt/tmp/v16/build/etc/rdma/rsocket"
#define IWPM_CONFIG_FILE "/data2/upstream/libbnxt/tmp/v16/build/etc/iwpmd.conf"

#define SRP_DEAMON_CONFIG_FILE "/data2/upstream/libbnxt/tmp/v16/build/etc/srp_daemon.conf"
#define SRP_DEAMON_LOCK_PREFIX "/usr/local/var/run/srp_daemon"

#define ACM_CONF_DIR "/data2/upstream/libbnxt/tmp/v16/build/etc/rdma"
#define IBACM_LIB_PATH "/data2/upstream/libbnxt/tmp/v16/build/lib/ibacm"
#define IBACM_BIN_PATH "/data2/upstream/libbnxt/tmp/v16/build/bin"
...
#define VERBS_PROVIDER_DIR "/data2/upstream/libbnxt/tmp/v16/build/lib"
#define VERBS_PROVIDER_SUFFIX "-rdmav16.so"
#define IBVERBS_PABI_VERSION 16
