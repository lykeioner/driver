...
#define SRP_DEAMON_CONFIG_FILE "/etc/srp_daemon.conf"
#define SRP_DEAMON_LOCK_PREFIX "/run/srp_daemon"
...
#define VERBS_PROVIDER_SUFFIX "-rdmav15.so"
#define IBVERBS_PABI_VERSION 15
